...
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Noto+Sans+TC:wght@100;400;900&display=swap);"]);
// Module
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var luxon__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(15);
/* harmony import */ var _src_images_substract_png__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(14);
...
class ViewTodos {
	...
	addTodo(todo) {
		let dt = "";
		if (todo.dueDate) {
			dt = luxon__WEBPACK_IMPORTED_MODULE_1__.DateTime.fromISO(todo.dueDate).toFormat("M月d日 HH:mm");
		}
		...
		const markup = `
      	<div slide-in-from="top"  class="todoList__item show" data-id=${todo.id}>
					...
					<div class="todoList__shbox">
						<img
							src="${_src_images_substract_png__WEBPACK_IMPORTED_MODULE_0__}"
							weight="50"
							height="50"
							alt="Delete button"
...
"use strict";
module.exports = __webpack_require__.p + "348f59c93d6239465f61.png";
...
/* harmony import */ var _viewTodos__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(13);
...
class Controller {
	constructor() {
		console.log(_model__WEBPACK_IMPORTED_MODULE_1__["default"].todos);
		// viewTodos.initRender(model.getListPage());
		_viewTodos__WEBPACK_IMPORTED_MODULE_2__["default"].initRender(_model__WEBPACK_IMPORTED_MODULE_1__["default"].todos);

		_viewTodos__WEBPACK_IMPORTED_MODULE_2__["default"].bindAddTodo(Controller.handleAddTodo);
		_viewTodos__WEBPACK_IMPORTED_MODULE_2__["default"].bindDeleteTodo(Controller.handleDeleteTodo);
		_viewTodos__WEBPACK_IMPORTED_MODULE_2__["default"].bindToggleTodo(Controller.handleToggleTodo);
		_viewTodos__WEBPACK_IMPORTED_MODULE_2__["default"].bindEditTodoText(Controller.handleEditTodoText);

		_model__WEBPACK_IMPORTED_MODULE_1__["default"].bindAddTodoRender(Controller.handleAddTodoRender);
		_model__WEBPACK_IMPORTED_MODULE_1__["default"].bindEditTodoRender(Controller.handleEditTodoRender);
	}

	static handleAddTodoRender(todo) {
		_viewTodos__WEBPACK_IMPORTED_MODULE_2__["default"].addTodo(todo);
	}

	static handleEditTodoRender(todos) {
		_viewTodos__WEBPACK_IMPORTED_MODULE_2__["default"].initRender(todos);
	}

	static handleAddTodo(todoText, todoDueDate) {
		if (!todoText) return;
		_model__WEBPACK_IMPORTED_MODULE_1__["default"].addTodo(todoText, todoDueDate);
	}

	static handleDeleteTodo(id) {
		_model__WEBPACK_IMPORTED_MODULE_1__["default"].deleteTodo(id);
	}

	static handleToggleTodo(id) {
		_model__WEBPACK_IMPORTED_MODULE_1__["default"].toggleTodo(id);
	}

	static handleEditTodoText(id, updatedText) {
		_model__WEBPACK_IMPORTED_MODULE_1__["default"].editTodoText(id, updatedText);
	}
}
